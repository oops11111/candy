...
Requires: `webServer` · `controlPlaneStore`
...
Source: [`packages/control-plane/device-api/src/index.ts:101`](../packages/control-plane/device-api/src/index.ts)
...
Source: [`packages/control-plane/oauth-sign-in-web/src/index.ts:49`](../packages/control-plane/oauth-sign-in-web/src/index.ts)
...
Requires: `subagents` · `runScheduler`
...
Depends on: [`RunBudget`](subsystems/candy-control-plane.md)

Source: [`packages/control-plane/run-delegation/src/index.ts:38`](../packages/control-plane/run-delegation/src/index.ts)

<a id="deepseek-aidsh-run-scheduler"></a>

## `@deepseek-ai/dsh-run-scheduler`

Requires: `controlPlaneStore` · `timer`
...
Source: [`packages/control-plane/run-scheduler/src/index.ts:81`](../packages/control-plane/run-scheduler/src/index.ts)
...
Requires: `agentPresets` · `runScheduler`
...
- `@deepseek-ai/dsh-candy-host` — requires `deviceBinding` · `CANDY_HOST_STARTUP_SERVICE` ([`packages/bundle/candy-host/src/index.ts`](../packages/bundle/candy-host/src/index.ts))
...
- `@deepseek-ai/dsh-control-plane-store` — requires `storageDomain` ([`packages/control-plane/control-plane-store/src/index.ts`](../packages/control-plane/control-plane-store/src/index.ts))
- `@deepseek-ai/dsh-cordis-client-runner` ([`packages/extensions/cordis-client-runner/src/index.ts`](../packages/extensions/cordis-client-runner/src/index.ts))
- `@deepseek-ai/dsh-deepseek-llm-api-extensions` ([`packages/llm/deepseek-llm-api-extensions/src/index.ts`](../packages/llm/deepseek-llm-api-extensions/src/index.ts))
- `@deepseek-ai/dsh-device-binding` — requires `credentials` ([`packages/control-plane/device-binding/src/index.ts`](../packages/control-plane/device-binding/src/index.ts))
