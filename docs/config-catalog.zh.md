...
来源: [`packages/llm/llm-claude-cli/src/index.ts:30`](../packages/llm/llm-claude-cli/src/index.ts)
...
- `@deepseek-ai/dsh-candy-host` — 需要 `deviceBinding` · `CANDY_HOST_STARTUP_SERVICE`（[`packages/bundle/candy-host/src/index.ts`](../packages/bundle/candy-host/src/index.ts)）
...
- `@deepseek-ai/dsh-device-binding` —— 需要 `credentials`（[`packages/control-plane/device-binding/src/index.ts`](../packages/control-plane/device-binding/src/index.ts)）
