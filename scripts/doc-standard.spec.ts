...
const PACKAGE_LIBRARIES: Readonly<Record<string, string>> = {
  ...
  'packages/control-plane/claude-cli-binding': 'Admitted-run to Claude CLI launch composition; plain function exports, no plugin entry.',
  ...
  'packages/control-plane/oauth-sign-in': 'OAuth callback and Candy identity mapping composition; plain function exports, no plugin entry.',
  'packages/control-plane/provider-accounts': 'Tenant provider-account management; plain function exports, no plugin entry.',
  ...
  'packages/control-plane/device-registry': 'The device and pairing-code records with their pairing, revocation and admission rules; plain type/function exports, no plugin entry.',
