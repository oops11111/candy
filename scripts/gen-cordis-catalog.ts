...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  AuditSubject: 'candy-control-plane.md',
  DurableRunRecord: 'candy-control-plane.md',
  RunAuditRecord: 'candy-control-plane.md',
  WorkspaceGrantId: 'candy-control-plane.md',
  ProviderKind: 'candy-control-plane.md',
  ProviderAccountValidation: 'candy-control-plane.md',
  ProviderCredentialCheck: 'candy-control-plane.md',
  ControlPlaneRole: 'candy-control-plane.md',
  OAuthIdentity: 'candy-control-plane.md',
  UserSessionId: 'candy-control-plane.md',
  UserSessionRecord: 'candy-control-plane.md',
  ...
  LlmRouteGuard: 'llm-streaming.md',
  LlmRouteRefusal: 'llm-streaming.md',
  LlmRouteSelection: 'llm-streaming.md',
  ...
  SubprocessLaunched: 'subprocess.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  AgentPresetGuard: 'preset-resolution guard function is owned by packages/preset/agent-presets/README.md',
  ...
  WorkspaceAccess: 'service-local filesystem access vocabulary is owned by packages/sandbox/sandbox/README.md',
