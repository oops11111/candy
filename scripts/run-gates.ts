...
function docSyncLeafGates(options: {
  ...
  return [
    ...
    pnpmScript('candy-deployment', 'verify-candy-deployment', { label: 'Candy deployment artifacts', quick: true }),
    ...
    pnpmScript('llm-adapter-contract', 'verify-llm-adapter-contract', { label: 'llm adapter contract' }),
