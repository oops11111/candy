...
export const GROUPS_WITHOUT_SUBSYSTEM_PAGE: Readonly<Record<string, string>> = {
  ...
  'control-plane': 'Identity-only foundation (branded ids and run ancestry, no running service yet); docs/candy-runtime-boundaries.md owns the accepted architecture until a real control-plane service exists to document as a subsystem.',
