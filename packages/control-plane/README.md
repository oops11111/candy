...
| [`device-binding`](device-binding/README.md) | The host's own record of which deployment it serves and as which device, singular by construction and released rather than replaced |
