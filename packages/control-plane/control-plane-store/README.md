...
- **The trail records what the control plane observes** — scheduling, vault, delegation, routing, tool authorization, provider-process launch, usage, and terminal state. Tool arguments, denial reasons, results, and launches outside a managed call are deliberately absent.
