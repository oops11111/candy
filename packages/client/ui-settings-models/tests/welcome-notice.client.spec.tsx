...
describe('WelcomeNotice', () => {
  it('uses the exact owner copy in both GUI locales', () => {
    expect(WELCOME_NOTICE_COPY.en).toEqual({
      ...
      body: 'Candy is in developer preview. Its multi-agent CLI runtime, account isolation, and remote-workspace integration will continue to evolve rapidly.\n\nCandy builds on the open-source DeepSeek Harness plugin ecosystem while keeping its product identity and deployment architecture independent.',
