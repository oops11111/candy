...
export const en = {
  ...
  welcomeBody: 'Candy is in developer preview. Its multi-agent CLI runtime, account isolation, and remote-workspace integration will continue to evolve rapidly.\n\nCandy builds on the open-source DeepSeek Harness plugin ecosystem while keeping its product identity and deployment architecture independent.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  creating: '创建中\u2026',
  welcomeTitle: '内测声明',
  welcomeBody: 'Candy 目前处于开发者预览阶段，多 agent CLI 运行时、账户隔离和远程工作区集成仍将快速演进。\n\nCandy 基于开源 DeepSeek Harness 插件生态构建，同时保持独立的产品身份和部署架构。',
  welcomeContinue: '继续',
